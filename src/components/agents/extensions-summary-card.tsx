  ...
  return (
    <div className="mb-5">
      <div className="flex items-center gap-2 mb-2 px-1">
        ...
        <span className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">Extensions</span>
        <span className="text-[10px] bg-muted px-1.5 py-0.5 rounded-full text-muted-foreground">{total}</span>
      </div>
      <button

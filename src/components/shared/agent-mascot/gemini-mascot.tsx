...
export function GeminiMascot({ size }: MascotSvgProps) {
  return (
    <div style={{ position: "relative", width: size, height: size, display: "flex", justifyContent: "center", alignItems: "center" }}>
      <svg className="glow-el" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
        style={{ width: size, height: size, position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%) scale(1.6)" }}>
      ...
      <div className="star-wrapper">
        <svg className="star-svg" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width={size * 0.6} height={size * 0.6}>
          ...
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="gm0" x1="7" x2="11" y1="15.5" y2="12">
              <stop stopColor="#08B962" /><stop offset="1" stopColor="#08B962" stopOpacity="0" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="gm1" x1="8" x2="11.5" y1="5.5" y2="11">
              <stop stopColor="#F94543" /><stop offset="1" stopColor="#F94543" stopOpacity="0" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="gm2" x1="3.5" x2="17.5" y1="13.5" y2="12">

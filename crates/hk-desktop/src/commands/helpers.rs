...
pub(super) fn audit_extension_by_name(name: &str, extensions: &[Extension], adapters: &[Box<dyn adapter::AgentAdapter>]) -> Vec<AuditResult> {
...
pub fn list_dir_entries(dir: &std::path::Path, depth: u8) -> Result<Vec<FileEntry>, String> {
